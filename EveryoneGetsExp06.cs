...
[assembly: MelonInfo(typeof(EveryoneGetsExp06), "Everyone Gets Experience 50% (0.6 ver.)", "1.0.0", "Matthiew Purple")]
        ...
        public static void Postfix()
        {
            ...
            for (int i = 0; i < dds3GlobalWork.DDS3_GBWK.unitwork.Length; i++)
            {
                if (dds3GlobalWork.DDS3_GBWK.unitwork[i].hp > 0)
                {
                    ...
                    {
                        datCalc.datAddExp(dds3GlobalWork.DDS3_GBWK.unitwork[i], (int)(nbResultProcess.AllExp * 0.5)); // Get 50% exp
                    }
